...
def viz_hypertension_vs_stroke(df):    
    ...
    ax=sns.barplot(x="hypertension", y='stroke', data=df, palette='Blues',edgecolor='white',linewidth=3,ci=None)
...
def viz_heart_hyper_stroke(train):  
    ...
    plt.subplot(122)
    ax=sns.barplot(x="hypertension", y='stroke', data=train, palette='Blues',edgecolor='white',linewidth=3, ci=None)
    ...
    plt.subplot(121)
    ax2=sns.barplot(x="heart_disease", y='stroke', data=train, palette='Blues',edgecolor='white',linewidth=3,ci=None)
    mean_line = train.stroke.mean()
    plt.axhline(mean_line, label='Stroke Rate', color='#0b559f',linestyle='-.', linewidth=3)
    ...
    ax2.set_title('Heart Disease Population', fontsize=30,color='#0b559f')
...
def viz_gender_heart_stroke(train):    
    ...
    ax = sns.barplot(data=train, x='gender_Male', y='stroke',hue='heart_disease',palette='Blues',
                     edgecolor='white',linewidth=3,ci=None)
...
def viz_age_vs_stroke(train):  
    ...
    plt.subplot(122)
    ax2 = sns.stripplot(data=train,y='age',x='stroke', alpha=0.5,jitter=True,edgecolor='white',linewidth=.5 )
    ax2.set(facecolor='floralwhite')
